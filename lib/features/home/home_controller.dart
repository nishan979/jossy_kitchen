...
class HomeController extends GetxController {
  ...
  List<String> categories = ['Popular', 'Local', 'Intercontinental'];

  List<FoodModel> allDishes = [
    FoodModel('Eba with okro soap', 'Spiced with sea fish', 3500, 'assets/food_image/Soup.png', 'Popular'),
    FoodModel('Spaghetti with chicken', 'Spiced with ugu leave', 3000, 'assets/food_image/Spaghetti.png', 'Popular'),
    FoodModel('Beans with dodo', '', 1500, 'assets/food_image/Dodo.png', 'Local'),
    FoodModel('Jollof rice with chicken', 'Spiced with dodo', 1500, 'assets/food_image/Jollof.png', 'Local'),
  ];
